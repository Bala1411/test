...
#         rospy.loginfo("________ROBOT LOG________")
...
if __name__ == "__main__":
    ...
    x1 = posx(399,524.38,-81.42,19.95,-179.22,-31.92)
    x2 = posx(-48.24,663.20,-81.04,115.41,178.86,22.27)
    ...
    while rospy is not shutdown: 
        ...
        task_compliance_ctrl(stx=[10, 10, 10, 5, 5, 5],time = 0.1)
        fd = [0, 0, -50, 0, 0, -50]
        fctrl_dir= [1, 1, 1, 1, 1, 1]
        set_desired_force(fd, dir=fctrl_dir,time = 0.1, mod=DR_FC_MOD_REL)
        movel(x2, velx, accx)
        # release_force(0.1)
